...
public class OrderController {
    ...
    @ApiImplicitParam(name = "id", required = true, value = "订单的编号",paramType = "path",type = "Long")
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "id",paramType = "path",value = "订单编号", type = "Long"),
            @ApiImplicitParam(name = "status",paramType = "path",value = "订单状态：1未付款，2已付款未发货，3已发货未确认，4已确认未评价，5交易关闭，6交易成功，已评价", type = "Integer"),
    })
    ...
    @ApiImplicitParam(name = "id", value = "订单编号", type = "Long",paramType = "path")
    @ApiResponses({
